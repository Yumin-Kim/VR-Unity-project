...
public class ContactConfirm3Script : MonoBehaviour
{
    // Start is called before the first frame update

    public static bool checkBox3Valid;
    ...
    {
        num = (InstanceScript.G_Count * 4) % 4 + 2;
        if (InstanceScript.G_Count > 0)
        {
            num = InstanceScript.G_Count * 4 + 2;
        }
        Debug.Log(num);
       /* if (OVRGrabber.CheckThisGrab && !checkBox3Valid)
